...
fetch('pokemones.json')
    ...
    function mostrarListaPokemonFiltrados(pokemones) {
        let container = document.getElementById('lista-pokemon');
        container.innerHTML = '';
    ...
    function buscarPokemon(name) {
        let filteredList = listaPokemon.filter(pokemon => pokemon.name.toLowerCase().includes(name.toLowerCase()));
        mostrarListaPokemonFiltrados(filteredList);
    }
